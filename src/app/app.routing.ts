...
import { IndexBannerComponent } from "./components/banner/index-banner/index-banner.component";
...
import { IndexCatalogoComponent } from "./components/catalogo/index-catalogo/index-catalogo.component";
import { CreateCatalogoComponent } from "./components/catalogo/create-catalogo/create-catalogo.component";
import { EditCatalogoComponent } from "./components/catalogo/edit-catalogo/edit-catalogo.component";
...
const appRoute : Routes = [ //aca creamos todas las rutas
    ...
    {path: 'panel', children: [
        ...
        {path: 'banners', component: IndexBannerComponent, canActivate: [AdminGuard]},
        {path: 'banners/registro', component: CreateBannerComponent, canActivate: [AdminGuard]},
        {path: 'banners/:id', component: EditBannerComponent, canActivate: [AdminGuard]},

        {path: 'catalogo', component: IndexCatalogoComponent, canActivate: [AdminGuard]},
        {path: 'catalogos/registro', component: CreateCatalogoComponent, canActivate: [AdminGuard]},
        {path: 'catalogos/:id', component: EditCatalogoComponent, canActivate: [AdminGuard]},
